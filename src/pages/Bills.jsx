...
export default function Bills() {
  ...
  return (
    <div className="space-y-8 animate-fade-in-up">
      <div>
        <h1 className="text-3xl font-bold text-gray-800 tracking-tight">Billing & Payments</h1>
        <p className="text-gray-500 mt-1">View invoices and manage your balances.</p>
      </div>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="glass-card p-8 bg-gradient-to-br from-primary-600 to-indigo-800 text-white relative overflow-hidden shadow-xl shadow-primary-900/20 rounded-2xl">
      ...
      <div className="glass-card overflow-hidden shadow-sm rounded-2xl">
        ...
        <table className="w-full text-left whitespace-nowrap">
          ...
          <tbody className="divide-y divide-gray-50">
            {bills.map((bill) => (
              <tr key={bill.id} className="hover:bg-primary-50/30 transition-colors group">
                <td className="px-6 py-5 font-bold text-gray-900 flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-gray-50 flex items-center justify-center text-gray-400 group-hover:bg-primary-100 group-hover:text-primary-600 transition-colors">
                ...
                <td className="px-6 py-5 font-extrabold text-gray-900 text-lg">${bill.amount}</td>
                <td className="px-6 py-5">
                ...
                <td className="px-6 py-5 text-right">
                  <button className="p-2.5 text-gray-400 hover:text-primary-600 hover:bg-primary-100 rounded-xl transition-all inline-block hover:shadow-sm">
